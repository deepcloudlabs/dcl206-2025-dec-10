...
import com.example.random.service.business.PostQuantumRandomNumberService;
...
module com.example.random {
	...
	with SecureRandomNumberService,FastRandomNumberService,PostQuantumRandomNumberService;
}